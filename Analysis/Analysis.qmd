...
To assess this, we'll calculate the percent difference of valence and arousal ratings,
...
apply(expressCVSig[,2:ncol(expressCVSig)],2, function(x) round(as.numeric(x)*100, 4)) -> expressCVSig[,2:ncol(expressCVSig)]
